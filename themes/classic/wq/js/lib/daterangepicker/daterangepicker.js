...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) { 
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            ...
            '<button class="cancelBtn"></button>' + '<br><br>' +
            '<button class="cleanBtn" style="width:100px"></button>' +//111111
            '</div>' +
            '</div>' +
            '</div>';
        ...
        if (this.cancelClass.length)//11111
            this.container.find('.cleanBtn').addClass(this.cleanClass);//11111
        this.container.find('.applyBtn').html(this.locale.applyLabel);
        this.container.find('.cancelBtn').html(this.locale.cancelLabel);
        this.container.find('.cleanBtn').html(this.locale.cleanLabel);//111111
        ...
        this.container.find('.ranges')
            ...
            .on('click.daterangepicker', 'button.cleanBtn', $.proxy(this.clickClean, this))//111111
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            if (this.opens == 'right' || this.opens == 'top') {
        ...
        move: function () {
            ...
            } else if (this.opens == 'top') {  // 修改opens:'top'时的方法
                var h = this.container.height();
                this.container.css({
                    top: this.element.offset().top - h - this.element.height(),
                    right: $(window).width() - this.element.offset().left - this.element.outerWidth() - parentOffset.left,
                    left: 'auto'
                });
                if (this.container.offset().left <= 0) {
                    this.container.addClass("openstop1");
                    this.container.css({
                        right: 'auto',
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if(this.format == 'MM/DD'){
                dateHtml = this.locale.monthNames[calendar[1][1].month()];
            }else{
