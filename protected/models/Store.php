 ...
 * @property string $marking_start_time
 * @property string $marking_end_time
 * @property string $alipay_apply_id
 */
class Store extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('merchant_id, management_id, alipay_sync_type, alipay_sync_verify_status, status, flag, is_print, if_wx_open, wx_use_pro, wx_merchant_type, if_alipay_open, alipay_use_pro, alipay_api_version, relation_store_id, edition', 'numerical', 'integerOnly'=>true),
			...
			array('alipay_store_id, phone_num, category_id, alipay_seller_id, licence_code, relation_right, alipay_apply_id', 'length', 'max'=>32),
	...
	public function attributeLabels()
	{
		return array(
			...
			'edition' => 'Edition',
			'marking_start_time' => 'Marking Start Time',
			'marking_end_time' => 'Marking End Time',
			'alipay_apply_id' => 'Alipay Apply',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('marking_start_time',$this->marking_start_time,true);
		$criteria->compare('marking_end_time',$this->marking_end_time,true);
		$criteria->compare('alipay_apply_id',$this->alipay_apply_id,true);
