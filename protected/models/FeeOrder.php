...
class FeeOrder extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, community_id, merchant_id, order_type, parking_type, car_id, parking_month_num, property_fee_month_num, pay_status, order_status, flag', 'numerical', 'integerOnly'=>true),
			array('peak, valley, electricity, water_ton, floor_space, pay_money, order_money', 'numerical'),
			array('building_number, user_account, order_no, trade_no', 'length', 'max'=>32),
			array('date, pay_time, create_time, last_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, community_id, merchant_id, building_number, user_account, order_no, order_type, date, peak, valley, electricity, water_ton, parking_type, car_id, parking_month_num, property_fee_month_num, floor_space, pay_money, order_money, pay_status, trade_no, order_status, pay_time, create_time, last_time, flag', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
		    'userInfo' => array(self::BELONGS_TO, 'proprietor', 'user_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('parking_type',$this->parking_type);
		...
		$criteria->compare('floor_space',$this->floor_space);
