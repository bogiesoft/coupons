...
class RefundRecord extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('order_id, merchant_id, store_id, operator_id, operator_admin_id, refund_channel, flag, type, status, terminal_type, refund_reason, order_sku_id, refund_num, if_return, user_express', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('refund_num',$this->refund_num);
