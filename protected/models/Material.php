...
class Material extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('img_path, customize_link', 'length', 'max'=>100),
			array('content, create_time, last_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, merchant_id, material_id, title, cover_img, abstract, jump_type, content, link_content, rate, create_time, last_time, flag, from_platform, img_path, customize_link', 'safe', 'on'=>'search'),
		);
	}
