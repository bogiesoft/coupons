 ...
 * @property integer $total_year_points
 * @property double $total_trade
 * @property double $total_year_trade
 *
 * The followings are the available model relations:
 * @property UserGrade $membershipgrade
 */
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('merchant_id, type, sex, marital_status, points, membershipgrade_id, login_client, alipay_status, alipay_user_type_value, alipay_subscribe_store_id, wechat_status, wechat_sex, wechat_subscribe_store_id, switch, flag, if_perfect, total_points, total_year_points', 'numerical', 'integerOnly'=>true),
			array('free_secret, money, total_trade, total_year_trade', 'numerical'),
			...
			array('id, merchant_id, type, account, pwd, avatar, nickname, name, sex, birthday, social_security_number, email, marital_status, work, country, province, province_code, city, city_code, free_secret, money, points, membershipgrade_id, membership_card_no, login_time, login_ip, login_client, regist_time, from, address, alipay_fuwu_id, alipay_status, alipay_avatar, alipay_nickname, alipay_province, alipay_city, alipay_gender, alipay_user_type_value, alipay_is_licence_auth, alipay_is_certified, alipay_certified_grade_a, alipay_is_student_certified, alipay_is_bank_auth, alipay_is_mobile_auth, alipay_user_status, alipay_is_id_auth, alipay_logon_id, alipay_user_name, alipay_subscribe_time, alipay_cancel_subscribe_time, alipay_subscribe_store_id, register_address, wechat_status, wechat_id, wechat_nickname, wechat_sex, wechat_country, wechat_province, wechat_city, wechat_language, wechat_headimgurl, wechat_unionid, wechat_remark, wechat_groupid, wechat_subscribe_time, wechat_cancel_subscribe_time, wechat_subscribe_store_id, switch, last_time, create_time, flag, if_perfect, total_points, total_year_points, total_trade, total_year_trade', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'total_year_points' => 'Total Year Points',
			'total_trade' => 'Total Trade',
			'total_year_trade' => 'Total Year Trade',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('total_year_points',$this->total_year_points);
		$criteria->compare('total_trade',$this->total_trade);
		$criteria->compare('total_year_trade',$this->total_year_trade);
