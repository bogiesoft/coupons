 ...
 * @property double $wxpay_discount_money
 ...
 * @property integer $if_has_points
 */
class Order extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('store_id, merchant_id, operator_id, user_id, order_type, pay_channel, pay_status, order_status, stored_confirm_status, flag, print, freight_print, if_use_coupons, terminal_type, pay_passageway, if_has_points', 'numerical', 'integerOnly'=>true),
			array('stored_paymoney, online_paymoney, unionpay_paymoney, cash_paymoney, order_paymoney, freight_money, hongbao_money, coupons_money, discount_money, undiscount_paymoney, merchant_discount_money, alipay_discount_money, wxpay_discount_money, commission_ratio', 'numerical'),
			...
			array('id, store_id, merchant_id, operator_id, user_id, order_no, order_type, trade_no, pay_channel, stored_paymoney, online_paymoney, unionpay_paymoney, cash_paymoney, pay_status, order_status, stored_confirm_status, pay_time, flag, address, remark, send_time, receive_time, print, freight_print, cancel_time, create_time, last_time, if_use_coupons, order_paymoney, freight_money, alipay_account, user_code, hongbao_money, coupons_money, discount_money, undiscount_paymoney, seller_remark, complete_time, ums_code, ums_card_no, terminal_type, terminal_id, merchant_discount_money, alipay_discount_money, wxpay_discount_money, third_party_order_id, pay_passageway, commission_ratio, thrid_party_code, wechat_user_id, alipay_user_id, wechat_user_p_id, if_has_points', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
		    ...
		    'order_sku'=>array(self::HAS_MANY,'OrderSku','order_id'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'wxpay_discount_money' => 'Wxpay Discount Money',
	...
	public function search()
	{
		...
		$criteria->compare('wxpay_discount_money',$this->wxpay_discount_money);
		...
		$criteria->compare('if_has_points',$this->if_has_points);
