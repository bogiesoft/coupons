    ...
    <div class="storeManage">
        ...
        <div class="bus-contant">
            <div class="user_detail_nav">
                ...
                <li onClick="window.self.location.href='<?php echo Yii::app()->createUrl('mCenter/user/userExpenses', array('id'=>$_GET['id'])) ?>'" class="active">消费记录</li>
                    ...
                    <select class="wq_form_control" name='store_id'>
                        ...
                        <?php 
                            if(!empty($stores))
                            {
                                ...
                                {
                        ?>
                        <option value="<?php echo $store->id?>" <?php if(isset($_GET['store_id']) && $_GET['store_id'] == $store->id) echo "selected";?>><?php echo $store->name?></option>
                        <?php 
                                }
                            }
                        ?>
