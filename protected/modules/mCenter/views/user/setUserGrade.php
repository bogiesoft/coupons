...
<div class="kkfm_r_inner">
   <div class="top">
        ...
        <?php if($change){?>
        <div class="policy">
            <a href="<?php echo Yii::app()->createUrl('crm/UserGrade/ReleaseUserGrade',array('num'=>$num))?>" class="post_policy">发布会员制度</a>
            <a href="<?php echo Yii::app()->createUrl('crm/UserGrade/RevertUserGrade')?>" class="undo_policy">还原上次会员制度</a>
            <p class="tips">
        ...
        <div class="btn_com_grade_wrap">
            <a href="<?php echo Yii::app()->createUrl('mCenter/user/AddUserGrade')?>">
    ...
    <div class="vipCard"> 
        ...
        <div class="item clearfix">
            ...
            <div class="shade">
                <a href="<?php echo Yii::app()->createUrl('mCenter/user/editUserGrade',array('id'=>$lists['id'],'k'=>$lists['if_default']))?>" class="edit"></a> 
            </div>
        </div>
         <?php } ?>
        <!--end item-->
        ...
        <div class="item item01 clearfix">
            ...
            <div class="shade">
                <a href="<?php echo Yii::app()->createUrl('mCenter/user/editUserGrade',array('id'=>$v['id'],'k'=>$v['if_default']))?>" class="edit"></a> 
                <a href="<?php echo Yii::app()->createUrl('mCenter/user/delUserGrade',array('id'=>$v['id']))?>" class="del" onclick="return confirm('确定此操作吗？');"></a>        
            </div>
        </div>
            <?php } } ?>
