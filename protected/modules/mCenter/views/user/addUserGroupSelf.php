        ...
        <div class="storeManage">
            ...
            <div class="bus-contant new_group_wrap">
                <div class="btn_l level_r">
                  <!--<a href="<?php echo Yii::app()->createUrl('mCenter/user/addUserGroupSearch'); ?>" class="btn_com_gray btn_gray_group">根据条件筛选</a>
                  <a href="<?php echo Yii::app()->createUrl('mCenter/user/addUserGroupSearch_1'); ?>" class="btn_com_gray btn_gray_group">根据条件筛选_1</a>-->
                  <a href="<?php echo Yii::app()->createUrl('mCenter/user/addUserGroupSelf'); ?>" class="btn_com_blue btn_blue_group">自定义分组</a>
                </div>
