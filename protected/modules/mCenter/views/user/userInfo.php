    ...
    <div class="storeManage">
        ...
        <div class="bus-contant">
            <div class="user_detail_nav">
                ...
                <li onClick="window.self.location.href='<?php echo Yii::app()->createUrl('mCenter/user/userInfo', array('id'=>$_GET['id'])) ?>'" class="active">用户信息</li>
                            ...
                            <div class="user_detail_box">
                                <div class="user_info_wrap clearfix">
                                    ...
                                    <div class="user_info">
                                        <p class="user_name">
                                            ...
                                            <span class="<?php if($user->sex == SEX_MALE) echo 'male'; if($user->sex == SEX_FEMALE) echo 'female';?>"></span>
                                        </p>
                                        <p class="phone"><span>手机号：<?php echo $user->account?></span><span>会员卡号：<?php echo $user->membership_card_no?></span></p>
                                        <?php if($user->birthday){?><p class="birth"><?php echo $user->birthday?date('Y.m.d', strtotime($user->birthday)):'1970.01.01'?></p><?php }?>
                                ...
                                <ul class="consume_info">
                                    <li>
                                        ...
                                        <span class="number">
                                        <?php 
                                            echo $user->total_trade?$user->total_trade:0;
                                        ?>
                                        </span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span>累计积分</span>
                                        <span class="number"><?php echo $user->total_points?$user->total_points:0;?></span>
                                    </li>
                                    <li>
                                        <span>储值金额</span>
                        ...
                        <div class="user_detail_item">
                            <div class="user_detail_box">
                                <div class="member_header">
                                    <span class="member_level"><?php echo $user->grade->name?></span> 注册时间：<?php echo $user->regist_time?$user->regist_time:''?>
                                </div>
                                <div class="member_card">
                                    <div class="card_preview">
                                        <?php 
                                            $membercard_img_src = $user->grade->membercard_img;
                                        ...
                                        <h3><?php echo $user->grade->name?></h3>
                                    </div>
                                    <div class="member_growth">
                                        ...
                                        <?php 
                                            if(!empty($user->growupRecord))
                                            {
                                                ...
                                                {
                                        ?>
                                        <p><?php echo $record->user_grade_name?>：<?php echo $record->create_time?></p>
                                        <?php 
                                                }
                                            }
                                        ?>
                        ...
                        <div class="user_detail_item">
                            ...
                            <div class="user_detail_box">
                                <ul class="user_info_more">
                                    ...
                                    <li>
                                        <span>公众号关注时间：<?php echo $user->wechat_subscribe_time?$user->wechat_subscribe_time:''?></span>
                                        <span>最后登录时间：<?php echo $user->login_time?$user->login_time:''?></span></li>
                                    <li>
                                        <span>服务窗关注时间：<?php echo $user->alipay_subscribe_time?$user->alipay_subscribe_time:''?></span>
                                        <span>最后登录客户端：<?php echo $user->login_client?$user_login_clients[$user->login_client]:'无'?></span></li>
                                </ul>
                                <!--
                            ...
                            ?>
                                ...
                                <ul>
                                    <h2 class="first"><a href="javascript:;"><?php echo $k?>年</a></h2>
                                        ...
                                        ?>
                                        <li class="green">
                                        <h3><?php echo date('m-d', strtotime($vv['time']))?><span><?php echo $k?></span></h3>
                                        <dl>
