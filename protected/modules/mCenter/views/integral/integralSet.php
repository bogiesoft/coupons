...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="center" class="inline-operate">
                        	<?php if ($storedflag == 1){?>
                            	...
                            	<a href="<?php echo Yii::app()->createUrl('mCenter/integral/stop',array('type'=>1)) ?>">停用</a>
                        	<?php }elseif($storedflag == 2){?>
                        		<a href="<?php echo Yii::app()->createUrl('mCenter/integral/use',array('type'=>1)) ?>">启用</a>
                        	<?php }else {?>
                        		<a href="javascript:void(0);" onclick="showStored()">编辑</a>
                        	<?php }?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="center" class="inline-operate">
							<?php if ($clearflag == 1){?>
                            	...
                            	<a href="<?php echo Yii::app()->createUrl('mCenter/integral/stop',array('type'=>2)) ?>">停用</a>
                        	<?php }else if($clearflag == 2){?>
                        		<a href="<?php echo Yii::app()->createUrl('mCenter/integral/use',array('type'=>2)) ?>">启用</a>
                        	<?php }else {?>
                        		<a href="javascript:void(0);" onclick="showclearpoints()">编辑</a>
                        	<?php }?>
                        </td>
        ...
        <!-- 储值弹出框 -->
        <?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/integral/SetStoredPoints'), 'get')?>
        ...
        <!-- 积分清理弹出框 -->
        <?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/integral/setClearpoints'), 'get')?>
        ...
        <?php echo CHtml::endForm();?>
        <!-- 消费弹出框 -->
        <?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/integral/IntegralSet'), 'get')?>
