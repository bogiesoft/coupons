...
<div class="g-container">
    <ul class="nav nav-tabs m-nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/WFeeOrderList')?>">水费</a>
        </li>
        <li class="nav-item">
    ...
    <div class="excel-operate cost-manage-excel-operate">
        <button type="button" onclick="window.location.href = '<?php echo Yii::app()->createUrl('mCenter/feeOrder/getModels', array(
            'order_type' => FEEORDER_TYPE_WATER_FEE))?>'">EXCEL模板下载</button>
    ...
    <div class="m-estate-box set-cost-box cost-manage-box">
        <div class="m-search">
            <div class="form-inline">
                ...
                echo Yii::app()->createUrl('mCenter/FeeOrder/WFeeOrderSelect');?>">
                            ...
                            <td>
                                <div class="m-operate">
                                    ...
                                    <ul class="m-operate-list">
                                        ...
                                        <li><a href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/WFeeOrderDetail',
    ...
    $(function () {
        $('#file').uploadify({
            ...
            onUploadSuccess: function (file, data, response) {//一个文件上传成功后的响应事件处理
                ...
                $.ajax({
                    url: '<?php echo $this->createUrl('importData1');?>?' + new Date().getTime(),
