...
<div class="g-container">
    <ul class="nav nav-tabs m-nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/ParkingFeeOrderList')?>">停车费</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/PropertyFeeOrderList')?>">物业费</a>
        </li>
    </ul>
    <div class="excel-operate cost-manage-excel-operate">
        <button type="button" onclick="window.location.href = '<?php echo Yii::app()->createUrl('mCenter/feeOrder/getModels', array(
            'order_type' => FEEORDER_TYPE_PARKING_FEE))?>'">EXCEL模板下载</button>
    ...
    <div class="m-estate-box set-cost-box cost-manage-box">
        <div class="m-search">
            <div class="form-inline">
                ...
                echo Yii::app()->createUrl('mCenter/FeeOrder/ParkingFeeOrderSelect');?>">
                ...
                <?php if (!empty($fee_Order_List)) { ?>
                    <?php foreach ($fee_Order_List as $k => $v) { ;?>
                        <tr>
                            ...
                            <td><?php echo $v['parking_month_num'];?></td>
                                ...
                                <div class="m-operate">
                                    ...
                                    <ul class="m-operate-list">
                                        <?php if($v['pay_status'] == ORDER_STATUS_UNPAID) {?>
                                            <li><a href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/GetFeeStatus', array('order_id' => $v['order_id'], 'order_type' => FEEORDER_TYPE_PARKING_FEE, 'goUrl' => Yii::app()->request->url));?>">确认</a></li>
                                        <?php }?>
                                        ...
                                        <li><a href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/ParkingFeeOrderDetail',
    ...
    $(function () {
        $('#file').uploadify({
            ...
            onUploadSuccess: function (file, data, response) {//一个文件上传成功后的响应事件处理
                ...
                $.ajax({
                    url: '<?php echo $this->createUrl('importData2');?>?' + new Date().getTime(),
