...
<div class="g-container">
    <ul class="nav nav-tabs m-nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/EFeeOrderList')?>">电费</a>
            <!--激活状态增加active-->
        </li>
        <li class="nav-item">
    ...
    <div class="excel-operate cost-manage-excel-operate">
        <button type="button" onclick="window.location.href = '<?php echo Yii::app()->createUrl('mCenter/feeOrder/getModels', array(
            'order_type' => FEEORDER_TYPE_ELECTRICITY_FEE))?>'">EXCEL模板下载</button>
    ...
    <div class="m-estate-box set-cost-box cost-manage-box">
        <div class="m-search">
            <div class="form-inline">
                ...
                echo Yii::app()->createUrl('mCenter/FeeOrder/EFeeOrderSelect');?>">
                    ...
                    <td>
                        <div class="m-operate">
                            ...
                            <ul class="m-operate-list">
                                ...
                                <li><a href="<?php echo Yii::app()->createUrl('mCenter/FeeOrder/EFeeOrderDetail',
                                array('order_id'=>$v['order_id'],'type'=>$v['type']));?>">查看详情</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
