<body>
	<div class="kkfm_r_inner">
		...
		<div class="contant shopList">
	        <div class="cz"><a href="<?php echo Yii::app()->createUrl('mCenter/promotions/scratchAdd')?>" class="btn_com_blue">新增活动</a></div>
	              	...
	              	<?php if (!empty($list)) { ?>
	              		<?php foreach ($list as $k => $v) { ?>
	              			<tr>
			                    ...
			                    <td>
			                    	<a href="<?php echo Yii::app()->createUrl('mCenter/promotions/scratchAdd', array('id'=>$v['id']))?>" class="blue">编辑</a> -
			                    	<a href="<?php echo Yii::app()->createUrl('mCenter/promotions/scratchDel', array('id'=>$v['id']))?>" onclick="return confirm('确认删除吗？');" class="blue">删除</a>
