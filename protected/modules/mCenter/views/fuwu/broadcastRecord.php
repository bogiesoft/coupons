                ...
                <?php if ( !empty($record)) { ?>
                	<?php foreach ($record as $key => $value) { ?>
                		<tr>
		                    ...
		                    <td align="center">
		                    	<a href="<?php echo Yii::app()->createUrl('mCenter/fuwu/delAutoReply', array('reply_id'=>$key, 'type'=>REPLY_TYPE_BROADCAST))?>" onclick="return confirm('确认删除吗？');"><img src="<?php echo GJ_STATIC_IMAGES?>del.png"></a>
		                    </td>
		                </tr>
                	<?php } ?>
                <?php } ?>
