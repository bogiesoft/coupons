			...
			<div class="material">
		     	<div class="material-left">
		          ...
		          <div class="btn">
	                ...
	                <a href="<?php echo Yii::app()->createUrl('mCenter/fuwu/materialList')?>" class="btn_com_gray">取消</a>
		          </div>
		        </div>
		        <!--end left-->
		        <div class="material-right">
		        	<div class="title">
		        		<em>标题</em>
		        		<em><?php echo CHtml::textField('Material[title]', $model['title'], array('class'=>'entry','maxlength'=>'32', 'placeholder'=>'最多可以输入32个字' ,'id'=>'material_title'))?></em> 
		            ...
		            <div class="title">
		        		<em>摘要（选填）</em>
		        		<em><?php echo CHtml::textArea('Material[abstract]', $model['abstract'], array('class'=>'entry','maxlength'=>'120', 'placeholder'=>'最多可以输入120个字', 'style'=>'height:60px;', 'value'=>isset($_POST['Material']['abstract'])?$_POST['Material']['abstract']:''))?></em>
		            </div>
		            <div class="title">
		        		<em>详情</em>
		                <em>
...
// 								) );?>
							...
							<?php if($model['jump_type'] == MATERIAL_CONTENT_CUSTOMIZE_URL) { ?>
							<div id="customize" class="txt-bj" style="display: show">
							<?php }else {?>
							<div id="customize" class="txt-bj" style="display: none">
								<?php }?>
								<?php echo CHtml::textField('Material[customize_link]', $model['customize_link'], array('style'=>'width:300px;')); ?>
							</div>
