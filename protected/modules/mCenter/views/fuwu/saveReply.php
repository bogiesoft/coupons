		...
		<?php echo CHtml::beginForm();?>
	        ...
	        <div class="pop_content">
	            ...
	            <div class="filed">
	                 ...
	                 <span class="text">
	                 	<?php echo CHtml::textField('Reply[key_word]', $model['key_word'], array('class'=>'txt', 'placeholder'=>'请输入关键字', 'style'=>'width:250px'))?>
	                 </span>
	                 <font color="red" id="key_word_error"><?php echo Yii::app()->user->getFlash('key_word');?></font>
	            </div>
	            <div class="filed">
