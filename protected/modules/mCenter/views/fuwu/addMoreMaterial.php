    	...
    	<div class="left">
            <div class="item mutil">
                <div class="imgSet" id="big01">
					...
					<input type="hidden" value="" name="MaData[Data0][customize_link]">
                </div>
                ...
                <div class="list" id="msg01">
					...
					<input type="hidden" value="" name="MaData[Data1][customize_link]">
                </div>
		...
		<?php echo CHtml::beginForm();?>
        	<div class="mod-form">
            	<div class="label" id="productName">
                	<label>标题</label>
                    <?php echo CHtml::textField('Material[title]', '',  array('class'=>'entry','maxlength'=>'32','style'=>'width:75%;', 'placeholder'=>'最多可以输入32个字'))?>
