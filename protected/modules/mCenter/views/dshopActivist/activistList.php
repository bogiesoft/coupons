...
<div class="kkfm_r_inner">
     ...
     <div class="shop_menu">
    	<ul>
        	<li><a href="<?php echo Yii::app()->createUrl('mCenter/dshopOrder/orderList'); ?>">全部订单</a></li>
        	<li class="cur"><a href="<?php echo Yii::app()->createUrl('mCenter/dshopActivist/activistList'); ?>">维权订单</a></li>
        </ul>
     </div>
     <div class="orderList">
        <div class="orderWarp">           
                  	...
                  	<tr class="orderCon">
                        <td valign="top" width="388">
                            <a href="#">
                                ...
                                <div class="list-info">订单码号：<?php echo $v['thrid_party_code']; ?></div>
                            </a>   
                        </td>
                        <td class="border"><?php echo $val['price']; ?><span>*<?php echo $val['num']; ?></span></td>
                        <td class="border" width="90" rowspan=""><a href="<?php echo Yii::app()->createUrl('mCenter/dshopActivist/ActivistDetail',array('order_id'=>$v['id'],'order_sku_id'=>$val['id'],'order_status'=>$v['order_status'])); ?>" class="list-name"><?php echo isset($GLOBALS['ORDER_SKU_STATUS'][$val['status']]) && $val['status'] ==ORDER_SKU_STATUS_REFUND?'用户提交维权':'用户维权结束'; ?></a></td>
                        <td class="border" ><!--rowspan="--><?php /*echo count($v['order_sku']); */?><span><?php echo $v['user_phone']; ?></span></td>
...
<div class="popWrap" id="seller_remark_pop" style="width:550px;display:none">
 <?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/dshopOrder/editSellerRemark',array('type'=>'activistList')),'get',array('id'=>'editRemarkForm')); ?>
