<div class="kkfm_r_inner freightAdd">
    ...
    <div class="contant">
        <?php echo CHtml::beginForm('','post',array('id'=>'freightadd')) ?>
        <div class="filed">
            <span class="label"><em class="red">*</em>模板名称</span>
             <span class="text">
             	<?php echo CHtml::textField('freight_name','', array('id'=>'freightname','class' => 'txt', 'placeholder' => '运费模板名称(最长32个字)', 'maxlength' => '32', 'style' => 'width:400px'))?>
             </span>
...
<script type="text/javascript">
    ...
    $(document).on('click','#area1 #area',function(e){
        ...
        a.parent().parent().parent().parent().children('#liaa').each(function(e){
            ...
            if($(this).find('#aa').hasClass('')&&csdis<0)
            {
                cjia++;
            }
        });
...
//                   判断这个市是否是全区显示
        ...
        if(type==0)
        {
            ...
            html+="<td align='center'><input id='second_num"+editrow+"' name='ShopFreight["+editrow+"][second_num]' type='text' maxlength = '8' class='txt'></td>";//一列
            html+="<td align='center'><input id='second_freight"+editrow+"' name='ShopFreight["+editrow+"][second_freight]' maxlength = '8' type='text' class='txt'><input id='"+editrow+"' name='ShopFreight["+editrow+"][area]' type='text' style='display:none' value='"+inputValue+"'></td></tr>";//一列
            //添加行
        $('#setarea').remove();//删除一行
        ...
        else if(type==1)
        {
            ...
            html+="<td align='center'><input id='second_freight"+editrow+"' value='"+second_freight+"' name='ShopFreight["+editrow+"][second_freight]' maxlength = '8' type='text' class='txt'><input id='"+editrow+"' name='ShopFreight["+editrow+"][area]' type='text' style='display:none' value='"+inputValue+"'></td></tr>";//一列
            //替换行
    ...
    function save()
    {
        ...
        {
            $.ajax({
                url:"<?php echo Yii::app()->createUrl('mCenter/ShopFreight/AddCheckName')?>?name="+title.val(),
                type:"get",
                async:false,
                success:function(data)
                {
