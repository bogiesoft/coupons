<body>
	<div class="kkfm_r_inner">
		...
		<div class="material material-list">
	    	<div class="click">
	        	<a href="<?php echo Yii::app()->createUrl('mCenter/wechat/setSingleMaterial') ?>" class="ico5">+单图文</a>
	            <a href="<?php echo Yii::app()->createUrl('mCenter/wechat/addMoreMaterial')?>" class="ico6">+多图文</a>
	        </div>
	     		...
	     		<?php if ( !empty($model) ) { ?>
	     			<?php foreach ( $model as $key => $value ) { ?>
     					<div class="li">
			                ...
			                <div class="bottom">
			                	<?php if ($num == 1 ) {?>
				                    <span><a href="<?php echo Yii::app()->createUrl('mCenter/wechat/broadcastGroup')?>">发送</a></span>
				                    <span><a href="<?php echo Yii::app()->createUrl('mCenter/wechat/setSingleMaterial', array('material_id'=>$key))?>">编辑</a></span>
				                    <span class="no"><a href="<?php echo Yii::app()->createUrl('mCenter/wechat/DelMaterial', array('material_id'=>$key))?>" onclick="return confirm('确认删除吗？');">删除</a></span>
				                <?php } else { ?>
				                 	<span><a href="<?php echo Yii::app()->createUrl('mCenter/wechat/broadcastGroup')?>">发送</a></span>
				                    <span><a href="<?php echo Yii::app()->createUrl('mCenter/wechat/setMoreMaterial', array('material_id'=>$key))?>">编辑</a></span>
				                    <span class="no"><a href="<?php echo Yii::app()->createUrl('mCenter/wechat/DelMaterial', array('material_id'=>$key))?>" onclick="return confirm('确认删除吗？');">删除</a></span>
				                <?php } ?>
			                </div> 
				    	</div>  
