            ...
            <div class="bus-contant new_group_wrap new_label_wrap">
                ...
                <div class="new_group new_group_attr">
                    <div class="new_group_item">
                        <?php echo CHtml::beginForm(Yii::app()->createUrl($this->route,array('id'=>$id)), 'post', array('id' => 'label_form'))?>
                        <h3 class="first_title">属性标签</h3>
                        <div class="new_group_item_c">
                            <div class="basic_info_item">
                                <span>标签名</span>
                                <input type="text" class="text_group" name="label_name" value="<?php echo isset($_POST['label_name']) ? $_POST['label_name'] : $label -> name?>">
                        ...
                        <div class="new_group_item_c">
                            <div class="basic_info_item">
                                ...
                                <div class="attr_name" id="attr_name">
                                    <?php if($label -> value) { ?>
                                    <?php foreach($label -> value as $v) { ?>
                                    <span onclick="del(this)"><?php echo $v?><i>×</i><input type="hidden" name="values[]" value="<?php echo $v?>"></span>
                                    <?php } } ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="new_group_term">
                    <?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/label/editCondition',array('id'=>$id)), 'post', array('id' => 'condition_form'))?>
                    <div class="new_group">
                        <div class="new_group_item">
...
<script>
    ...
    $('input[name=label_name]').bind("blur focus keydown keypress keyup", function(){ 
