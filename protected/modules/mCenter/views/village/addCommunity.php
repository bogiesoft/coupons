<h4 class="g-title">添加小区</h4>
<?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/Village/AddCommunity'), 'post',array('id' => 'createForm')); ?>
    ...
    <div class="m-estate-box">
        <div class="form-group">
            ...
            <div class="estate-con form-inline">
                <?php echo CHtml::textField('name', isset($_POST['name']) ? $_POST['name'] : '', array('class' => 'form-control fc-sm', 'onblur' => 'checkName()')); ?>
        ...
        <div class="form-group">
            ...
            <div class="estate-con">
                <?php echo CHtml::textField('tel', isset($_POST['tel']) ? $_POST['tel'] : '', array('class' => 'form-control fc-sm')); ?>
            </div>
        </div>
        <div class="form-group">
            <div class="estate-title mt6">
            ...
            <div class="estate-con">
                <?php echo CHtml::textField('address', isset($_POST['address']) ? $_POST['address'] : '', array('class' => 'form-control fc-sm')); ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="estate-con">
                <?php echo CHtml::textArea('remark', isset($_POST['remark']) ? $_POST['remark'] : '', array('class' => 'form-control estate-textarea')); ?>
            </div>
        </div>
