...
<div class="g-container">
    ...
    <div class="m-tip submit-success-tip" id="create_tips" style="display: none">
        ...
        <div class="tip-content fl">
            <h5>创建成功！等待微信审核，审核期间您可先投放玩券电子券</h5>
    ...
    <div class="m-c-cp js-step-1" style="display: block">
        <div
            class="cp-l <?php echo isset($_POST['Coupons']['color']) ? $_POST['Coupons']['color'] : 'Color082' ?> js-cp-l">
                ...
                <div class="m-cp-preview-inner">
                    <div class="row row-cp-1">
                        <div class="col-sm-12 text-center">
                            <img id="left_logo_img"
                                 src="<?php echo empty($merchant_logo) ? 'http://uploadyhq.debug.51wanquan.com/images/gj/source/20160629/160629070828961469.png' : IMG_GJ_LIST . $merchant_logo; ?>"
                                 alt="" class="avatar">
                            <h5 class="store-name mt20"><?php echo isset($merchant_short_name) ? $merchant_short_name : '商家名称' ?></h5>
                        </div>
                        <div class="col-sm-12 text-center mt30">
                            <h2 class="text-black"
                                id="left_title"><?php echo isset($_POST['Coupons']['title']) ? $_POST['Coupons']['title'] : '优惠券标题' ?></h2>
                        </div>
                        <div class="col-sm-12 text-center mt10">
                            <h6 class="text-black"
                                id="left_vice_title"><?php echo isset($_POST['Coupons']['vice_title']) ? $_POST['Coupons']['vice_title'] : '副标题' ?></h6>
                        </div>
                        <div class="col-sm-12 text-center mt10">
                            <h5 class="btn-showuse Color082">立即使用</h5>
                        </div>
                        ...
                        <div class="col-sm-12 text-center mt15">
                            ...
                            <?php if (isset($_POST['Coupons']['begin_hour']) && !empty($_POST['Coupons']['begin_hour'])) { ?>
                                <h6 class="expiry-date">可用时间：<label id="left_available_hour">
                    ...
                    <div class="row row-cp-2">
                        ...
                        <div class="cp-cover mt15">
                            <img id="left_cover_img"
                                 src="<?php echo isset($_POST['Coupons']['cover_img']) ? IMG_GJ_LIST . $_POST['Coupons']['cover_img'] : ''; ?>"
                                 alt="">
                            <h5 id="left_cover_title"
                                class="title arrow-left"><?php echo isset($_POST['Coupons']['cover_img_title']) ? $_POST['Coupons']['cover_img_title'] : '' ?></h5>
                        </div>
                    ...
                    <div class="row row-cp-3">
                        <p id="entrance1"
                           class="arrow-left coupon-p text-black"><?php echo isset($_POST['Coupons']['custom_url_name']) ? $_POST['Coupons']['custom_url_name'] : '自定义入口（选填）' ?></p>

                        <p id="entrance2"
                           class="arrow-left coupon-p text-black"><?php echo isset($_POST['Coupons']['promotion_url_name']) ? $_POST['Coupons']['promotion_url_name'] : '自定义入口（选填）' ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cp-r">
            <section class="m-cp-item">
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        <div class="store-image">
                            <img id="merchant_logo"
                                 src="<?php echo empty($merchant_logo) ? IMG_GJ_LIST . '20160624/160624110804803797.jpg' : IMG_GJ_LIST . $merchant_logo ?>"
                                 alt="">
                            <input type="file" class="file" id="logo-upload">

                        </div>
                        <!-- <img src="<?php echo empty($merchant_logo) ? '' : IMG_GJ_LIST . $merchant_logo ?>" alt="" class="store-image">-->
                        <input type="hidden" name="Coupons[logo]"
                               value="<?php echo isset($_POST['Coupons']['logo']) ? $_POST['Coupons']['logo'] : isset($merchant_logo) ? $merchant_logo : '' ?>">
                        <input type="text" name="Coupons[merchant_short_name]" id=""
                               value="<?php echo isset($_POST['Coupons']['merchant_short_name']) ? $_POST['Coupons']['merchant_short_name'] : isset($merchant_short_name) ? $merchant_short_name : '' ?>"
                               class="form-control store-name fc-m-sm" placeholder="商家名称">
                        <span class="text1 red">
                              <?php if (Yii::app()->user->hasFlash('short_name_error')) { ?>
                                  <?php echo Yii::app()->user->getFlash('short_name_error'); ?>
                              <?php } ?>
                        </span>
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con js-cp-type">
                        ...
                        <div class="radio-inline">
                            <label>
                                <input type="radio" name="Coupons[type]" id="gift_type" value="4"> 兑换券
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="m-cp-color js-cp-color">
                            <div class="selected-box">
                                <input id="Couponscolor" type="hidden" name="Coupons[color]"
                                       value="<?php echo isset($_POST['Coupons']['color']) ? $_POST['Coupons']['color'] : 'Color082' ?>"/>

                                <div
                                    class="<?php echo isset($_POST['Coupons']['color']) ? $_POST['Coupons']['color'] : 'Color082' ?>"
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        <?php echo CHtml::textField('Coupons[title]', isset($_POST['Coupons']['title']) ? $_POST['Coupons']['title'] : '', array('class' => 'form-control fc-sm', 'placeholder' => '最多9个汉字', 'maxlength' => 9)); ?>
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        <?php echo CHtml::textField('Coupons[vice_title]', isset($_POST['Coupons']['vice_title']) ? $_POST['Coupons']['vice_title'] : '', array('class' => 'form-control fc-sm', 'placeholder' => '最多18个汉字', 'maxlength' => 18)); ?>
                    </div>
                </div>
                <div class="form-group m-cp-info">
                    <div class="cp-title mt6">
                    ...
                    <div class="cp-con js-effective-time">
                        <div class="radio form-inline mb10">
                            ...
                            <input type="text" name="Coupons[time]"
                                   value="<?php echo isset($_POST['Coupons']['time']) ? $_POST['Coupons']['time'] : '' ?>"
                            ...
                            <div class="mt20 partial-time js-partial-time-r" style="display: none">
                                ...
                                <div class="form-inline mt20">
                                    ...
                                    <input type="text" name="Coupons[begin_hour]"
                                           value="<?php echo isset($_POST['Coupons']['begin_hour']) ? $_POST['Coupons']['begin_hour'] : '' ?>"
                                           class="form-control fc-v-sm ml10 ">
                                    <span>至</span>
                                    <input type="text" name="Coupons[end_hour]"
                                           value="<?php echo isset($_POST['Coupons']['end_hour']) ? $_POST['Coupons']['end_hour'] : '' ?>"
                ...
                <div class="form-group m-cp-info js-cp-voucher">
                    ...
                    <div class="cp-con">
                        <div class="input-group fc-sm m-input-group">
                            <?php echo CHtml::textField('Coupons[reduce_cost]', isset($_POST['Coupons']['reduce_cost']) ? $_POST['Coupons']['reduce_cost'] : '', array('class' => 'form-control', 'placeholder' => '最多6位数字', 'maxlength' => 6)); ?>
                ...
                <div class="form-group m-cp-info js-cp-voucher">
                    ...
                    <div class="cp-con">
                        <div class="input-group fc-sm m-input-group">
                            <?php echo CHtml::textField('Coupons[least_cost]', isset($_POST['Coupons']['least_cost']) ? $_POST['Coupons']['least_cost'] : '', array('class' => 'form-control', 'placeholder' => '最多6位数字', 'maxlength' => 6)); ?>
                            <span class="input-group-addon">元</span>
                        </div>
                        <span class="text1 red">
                ...
                <div class="form-group m-cp-info js-cp-discount" style="display: none;">
                    ...
                    <div class="cp-con">
                        <div class="input-group fc-sm m-input-group">
                            <?php echo CHtml::textField('Coupons[discount_rule]', isset($_POST['Coupons']['discount_rule']) ? $_POST['Coupons']['discount_rule'] : '', array('class' => 'form-control', 'placeholder' => '最多6位数字', 'maxlength' => 6)); ?>
                            <span class="input-group-addon">元</span>
                        </div>
                ...
                <div class="form-group m-cp-info js-cp-discount" style="display: none;">
                    ...
                    <div class="cp-con">
                        <div class="input-group fc-sm m-input-group">
                            <input type="text" name="Coupons[discount]"
                                   value="<?php echo isset($_POST['Coupons']['discount']) ? $_POST['Coupons']['discount'] : '' ?>"
                                   class="form-control">
                ...
                <div class="form-group m-cp-info js-cp-exchange" style="display: none;">
                    ...
                    <div class="cp-con">
                        <div class="input-group fc-sm m-input-group">
                            <?php echo CHtml::textField('Coupons[gift_rule]', isset($_POST['Coupons']['gift_rule']) ? $_POST['Coupons']['gift_rule'] : '', array('class' => 'form-control', 'placeholder' => '最多6位数字', 'maxlength' => 6)); ?>
                            <span class="input-group-addon">元</span>
                        </div>
                        <p class="mt10 text-gray">消费满多少元可用,不填写则默认不限制</p>
                    </div>
            ...
            <section class="m-cp-item">
                ...
                <div class="form-group m-cp-info js-cp-use">
                    <div class="cp-title">
                        <span>使用条件</span>
                    </div>
                    <div class="cp-con">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox"
                                       name="Coupons[if_with_userdiscount]" <?php echo isset($_POST['Coupons']['if_with_userdiscount']) ? 'checked' : '' ?>
                                       value="2">可与会员折扣同时使用
                            </label>
                ...
                <div class="form-group m-cp-info js-cp-exchange" style="display: none;">
                    ...
                    <div class="cp-con">
                        <textarea class="form-control" name="Coupons[gift_info]" placeholder="请填写兑换的具体内容，最多300字"
                                  rows="5"></textarea>
                    <span class="text1 red">
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        <input type="text" id="Coupons_tel" name="Coupons[tel]"
                               value="<?php echo isset($_POST['Coupons']['tel']) ? $_POST['Coupons']['tel'] : '' ?>"
                        ...
                        <div class="m-upload">
                            <div class="upload-inner">
                                <img alt="" id="right_cover_img"
                                     src="<?php echo isset($_POST['Coupons']['cover_img']) && !empty($_POST['Coupons']['cover_img']) ? IMG_GJ_LIST . $_POST['Coupons']['cover_img'] : '' ?>">
                                ...
                                <div class="upload-icon">
                                    <div class="upload-btn">
                                        ...
                                        <input type="hidden" name="Coupons[cover_img]"
                                               value="<?php echo isset($_POST['Coupons']['cover_img']) ? $_POST['Coupons']['cover_img'] : '' ?>">
                                    </div>
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        <input type="text" name="Coupons[cover_img_text]"
                               value="<?php echo isset($_POST['Coupons']['cover_img_text']) ? $_POST['Coupons']['cover_img_text'] : '' ?>"
                               class="form-control fc-sm">
                    </div>
                </div>
                <div class="form-group m-cp-info">
            ...
            <section class="m-cp-item">
                        ...
                        <div class="form-group m-cp-info">
                            ...
                            <div class="cp-con">
                                <input type="text" name="Coupons[custom_url_name]"
                                       value="<?php echo isset($_POST['Coupons']['custom_url_name']) ? $_POST['Coupons']['custom_url_name'] : '' ?>"
                        ...
                        <div class="form-group m-cp-info">
                            ...
                            <div class="cp-con">
                                <input type="text" name="Coupons[custom_url_sub_title]"
                                       value="<?php echo isset($_POST['Coupons']['custom_url_sub_title']) ? $_POST['Coupons']['custom_url_sub_title'] : '' ?>"
                            ...
                            <div class="cp-con js-jump-link">
                                ...
                                <div class="form-group mt20 link-input">
                                    <input type="text" id="panel1_link" name="Coupons[custom_url]"
                                           value="<?php echo isset($_POST['Coupons']['custom_url']) ? $_POST['Coupons']['custom_url'] : '' ?>"
                                           class="form-control fc-sm">
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel panel-default m-panel js-entry-tpl" style="display: none;">
                    <div class="panel-heading">
                        ...
                        <div class="form-group m-cp-info">
                            ...
                            <div class="cp-con">
                                <input type="text" name="Coupons[promotion_url_name]"
                                       value="<?php echo isset($_POST['Coupons']['promotion_url_name']) ? $_POST['Coupons']['promotion_url_name'] : '' ?>"
                                       class="form-control fc-sm" placeholder="请填写入口名称">
                            </div>
                        </div>
                        <div class="form-group m-cp-info">
                            ...
                            <div class="cp-con js-jump-link">
                                ...
                                <div class="form-group mt20 link-input1">
                                    <input type="text" id="panel2_link" name="Coupons[promotion_url]"
                                           value="<?php echo isset($_POST['Coupons']['promotion_url']) ? $_POST['Coupons']['promotion_url'] : '' ?>"
                                           class="form-control fc-sm">
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-inline m-form-group mt30" style="margin-bottom:200px">
                <button type="submit" class="btn btn-primary m-btn" id="js-cp-next">下一步</button>
            ...
            <div class="panel panel-default m-panel">
                ...
                <div class="panel-body">
                        ...
                        <div class="cp-con">
                            <div class="input-group fc-sm">
                                <input type="text" name="Coupons[num]"
                                       value="<?php echo isset($_POST['Coupons']['num']) ? $_POST['Coupons']['num'] : '' ?>"
                                       class="form-control">
                        ...
                        <div class="cp-con">
                            <div class="input-group fc-sm">
                                <input type="text" name="Coupons[receive_num]"
                                       value="<?php echo isset($_POST['Coupons']['receive_num']) ? $_POST['Coupons']['receive_num'] : '' ?>"
                                       class="form-control">
                                <span class="input-group-addon">份</span>
                            </div>
                            <span class="text1 red">
                    ...
                    <div class="form-group m-cp-info">
                        <div class="checkbox-inline">
                            <label>
                                <input type="checkbox" name="Coupons[if_share]" value="1" checked>用户可以分享领券链接
                            </label>
                        </div>
                        <div class="checkbox-inline">
                            <label>
                                <input type="checkbox" name="Coupons[if_give]" value="1" checked>用户领券后可转增其他好友
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="form-group m-cp-info">
                        ...
                        <div class="cp-con">
                            <div class="checkbox-inline">
                                <label>
                                    <input type="checkbox" name="Coupons[channel1]" value="1" checked>线下门店
                                </label>
                            </div>
                            <div class="checkbox-inline">
                                <label>
                                    <input type="checkbox" name="Coupons[channel2]" value="2" checked>线上使用
                                </label>
                            </div>
                    ...
                    <div class="form-group m-cp-info">
                        ...
                        <div class="cp-con">
                            <input type="text" name="Coupons[prompt]"
                                   value="<?php echo isset($_POST['Coupons']['prompt']) ? $_POST['Coupons']['prompt'] : '' ?>"
                                   class="form-control fc-sm">
...
<div class="m-pop store-pop" style="display: none;">
    ...
    <script>
        $(function () {
            ...
            addCouponLogo_upload('logo-upload', '<?php echo UPLOAD_TO_PATH?>', '<?php echo WQ_STATIC_JS?>', "<?php echo UPLOAD_IMG_TYPE;?>", '<?php echo(IMG_GJ_FOLDER)?>', '<?php echo IMG_GJ_LIST?>');
        ...
        $("#js-add-imgpost").click(function () {
            ...
            i++;
            var id = i;
            addCouponImgList_upload(id, '<?php echo UPLOAD_TO_PATH?>', '<?php echo WQ_STATIC_JS?>', "<?php echo UPLOAD_IMG_TYPE;?>", '<?php echo(IMG_GJ_FOLDER)?>', '<?php echo IMG_GJ_LIST?>');
        ...
        $(function () {
            var no = 'none';
            var coupon_type = <?php echo isset($_POST['Coupons']['type']) ? $_POST['Coupons']['type'] : 'no'?>;
            if (coupon_type != 'no') {
            ...
            var time_type = "<?php echo isset($_POST['Coupons']['time_type'])?$_POST['Coupons']['time_type']:'no'?>";
            if (time_type != 'no') {
            ...
            var available_time = "<?php echo isset($_POST['Coupons']['available_time'])?$_POST['Coupons']['available_time']:'no'?>";
            if (available_time != 'no') {
...
//          }
//      }
            var storetype = "<?php echo isset($_POST['applicable-store'])?$_POST['applicable-store']:'no'?>";
            if (storetype != 'no') {
                $("input[name='applicable-store'][value=" + storetype + "]").attr("checked", 'checked');
            }
            var if_share = "<?php if(isset($_POST['Coupons']['if_share']) || empty($_POST)){echo 1;}else{echo 2;}?>";
            if (if_share == '1') {
                $("input[name='Coupons[if_share]']").attr("checked", 'checked');
            } else if (if_share == '2') {
                $("input[name='Coupons[if_share]']").attr("checked", false);
            }
            var if_give = "<?php if(isset($_POST['Coupons']['if_give']) || empty($_POST)){echo 1;}else{echo 2;}?>";
            if (if_give == '1') {
                $("input[name='Coupons[if_give]']").attr("checked", 'checked');
            } else if (if_give == '2') {
                $("input[name='Coupons[if_give]']").attr("checked", false);
            }
            var channel1 = "<?php if(isset($_POST['Coupons']['channel1']) || empty($_POST)){echo 1;}else{echo 2;}?>";
            if (channel1 == '1') {
                $("input[name='Coupons[channel1]']").attr("checked", 'checked');
            } else if (channel1 == '2') {
                $("input[name='Coupons[channel1]']").attr("checked", false);
            }
            var channel2 = "<?php if(isset($_POST['Coupons']['channel2']) || empty($_POST)){echo 1;}else{echo 2;}?>";
            if (channel2 == '1') {
...
//            var use_illustrate = "<?php //echo isset($_POST['Coupons']['use_illustrate'])?$_POST['Coupons']['use_illustrate']:'no' ?>//";
//            if (use_illustrate != 'no') {
//                $("textarea[name='Coupons[use_illustrate]']").html(use_illustrate);
//
//            }
//            var gift_info = "<?php //echo isset($_POST['Coupons']['gift_info'])?$_POST['Coupons']['gift_info']:'no' ?>//";
//            if (gift_info != 'no') {
...
//               $('#left_time').html('领取后'+$("dropDownList[name='Coupons[start_days]']").val()+'天生效，有效'+$("input[name='Coupons[effective_days]']").val()+'天');
//               //$('#left_time2').html('领取后'+$('#Coupons_start_days').val()+'天生效，有效'+$('#Coupons_effective_days').val()+'天');
//          }else{
//               $('#left_time').html('领取后当天生效，有效'+$("dropDownList[name='Coupons[effective_days]']").val()+'天');
