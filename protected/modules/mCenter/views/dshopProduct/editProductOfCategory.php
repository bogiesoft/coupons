		        	...
		        	<dl>
		                ...
		                <dd>
		                	<div class="filed">
		                        ...
		                        <span class="text" id="category_name">票务 > 门票</span>
		                    </div>
		                    <div class="filed">
		                    ...
		                    <div class="filed">
		                        ...
		                        <span class="text">		                            
		                            <input type="radio" name="Product[third_party_source]" value="<?php echo SHOP_PRODUCT_THIRED_TIANSHI?>"  <?php echo  $list['third_party_source'] == SHOP_PRODUCT_THIRED_TIANSHI ? 'checked="checked"' : ''?>>天时
                                            <input type="radio" name="Product[third_party_source]" value="<?php echo SHOP_PRODUCT_THIRED_ZHIYOUBAO?>" <?php echo $list['third_party_source'] == SHOP_PRODUCT_THIRED_ZHIYOUBAO ? 'checked="checked"' : ''?>>智游宝		                            
		                        </span>
		                    </div>
		                </dd>
		            </dl>
...
<!-- 		                        <span class="text"> -->
<!--  		                        	<input type="text" class="txt" name="Product[third_party_product_id]" value="<?php //echo $list['third_party_product_id']?>">-->
<!-- 		                        </span> -->
<!-- 		                    </div> -->
		                	<div class="filed">
										...
										<?php if (!empty($list['pro_sku'])) { ?>   
											<?php foreach ($list['pro_sku'] as $key => $value) { ?>
												<tr class="pro_sku">
													...
													<td align="center"><input type="text" class="txt" style="width:100px" value="<?php echo $value['merchant_no']?>" name="Product[pro][<?php echo $key?>][sku_code]"></td>
												</tr>
											<?php } ?>
										<?php } ?>
										<tr>
		                    ...
		                    <div class="filed">
		                        ...
		                        <span class="text">
                                    ...
                                    <div class="filed">
                                        ...
                                        <span class="text">
                                            <div class="block">
                                                <input type="radio" name="Product[use_time_type]" id="use_time_type_a" value="<?php echo DSHOP_TIME_TYPE_DAY?>" <?php if(!empty($list['use_time_type']) && $list['use_time_type'] == DSHOP_TIME_TYPE_DAY) { ?> checked="checked" <?php }?>> 购买起&nbsp;<input type="text" class="txt" id="date_num1" name="Product[date_num1]" <?php if(!empty($list['use_time_type']) && $list['use_time_type'] == DSHOP_TIME_TYPE_DAY) { ?>value="<?php echo isset($list['date_num']) ? $list['date_num'] : ''?>"<?php } ?> style="width:50px">&nbsp;天有效
                                            </div>
                                            <input type="radio" name="Product[use_time_type]" id="use_time_type_b" value="<?php echo DSHOP_TIME_TYPE?>" <?php if(!empty($list['use_time_type']) && $list['use_time_type'] == DSHOP_TIME_TYPE) { ?> checked="checked" <?php }?>> 自选游玩时间，购买起&nbsp;<input type="text" class="txt" id="date_num2" name="Product[date_num2]" <?php if(!empty($list['use_time_type']) && $list['use_time_type'] == DSHOP_TIME_TYPE) { ?>value="<?php echo isset($list['date_num']) ? $list['date_num'] : ''?>"<?php } ?> style="width:50px">&nbsp;天有效
                                        </span>
                                    </div>
                                    <!--入园时间 前台须知-->
                                    <div class="filed">
                                        ...
                                        <span class="text">
                                            <div class="block">
                                                <input type="radio" name="Product[check_time_type]" id="check_time_type_a" value="<?php echo DMALL_DPRODUCT_CHECK_TIME_TYPE_NO_LIMIT;?>" <?php if(!empty($list['check_time_type']) && $list['check_time_type'] == DMALL_DPRODUCT_CHECK_TIME_TYPE_NO_LIMIT) { ?> checked="checked" <?php }?>> 不限制
                                            </div>
                                            <div class="block">
                                                <input type="radio" name="Product[check_time_type]" id="check_time_type_b" value="<?php echo DMALL_DPRODUCT_CHECK_TIME_TYPE_DAY_HOUR_MINUTE;?>" <?php if(!empty($list['check_time_type']) && $list['check_time_type'] == DMALL_DPRODUCT_CHECK_TIME_TYPE_DAY_HOUR_MINUTE) { ?> checked="checked" <?php }?>> 请至少在入园前 
                                                <input oninput="checkZS(this)" onpropertychange="checkZS(this)" type="text" class="text" style="width:50px" name="Product[check_day]" id="check_day" <?php if($list['check_time_type'] != DMALL_DPRODUCT_CHECK_TIME_TYPE_DAY_HOUR_MINUTE){echo "disabled='disabled'";}?> value="<?php echo isset($list['check_day']) ? $list['check_day'] : 0;?>" /> 天的 

                                                <select name="Product[check_hour1]" <?php if($list['check_time_type'] != DMALL_DPRODUCT_CHECK_TIME_TYPE_DAY_HOUR_MINUTE){echo "disabled='disabled'";}?> id="check_hour1">
                                                	<?php 
                                                		for($i=0; $i<24; $i++)
                                          				{
                                                			echo "<option value='".$i."'";
                                                			if($list['check_hour']==$i){
                                                ...
                                                <select name="Product[check_minute1]" id="check_minute1" <?php if($list['check_time_type'] != DMALL_DPRODUCT_CHECK_TIME_TYPE_DAY_HOUR_MINUTE){echo "disabled='disabled'";}?>>
                                                	<?php 
                                                	for($i=0; $i<60; $i++)
                                                	{
                                                		echo "<option value='".$i."'";
                                                		if($list['check_minute']==$i){
                                                			echo "selected='selected'";
                                                		} 
                                                		echo ">".$i."</option>";
                                                	}?>
                                            ...
                                            <div class="block">
                                                <input type="radio" name="Product[check_time_type]" id="check_time_type_c" value="<?php echo DMALL_DPRODUCT_CHECK_TIME_TYPE_HOUR_MINUTE;?>"  <?php if(!empty($list['check_time_type']) && $list['check_time_type'] == DMALL_DPRODUCT_CHECK_TIME_TYPE_HOUR_MINUTE) { ?> checked="checked" <?php }?>> 请至少在入园前 
                                                <select name="Product[check_hour2]" id="check_hour2"  <?php if($list['check_time_type'] != DMALL_DPRODUCT_CHECK_TIME_TYPE_HOUR_MINUTE){echo "disabled='disabled'";}?>>
                                                <?php 
                                                for($i=0; $i<24; $i++)
                                                	{
                                                		echo "<option value='".$i."'"; 
                                            ...
                                            <select name="Product[check_minute2]" id="check_minute2" <?php if($list['check_time_type'] != DMALL_DPRODUCT_CHECK_TIME_TYPE_HOUR_MINUTE){echo "disabled='disabled'";}?>>
                                            <?php for($i=0; $i<60; $i++)
                                            {
                                            	echo "<option value='".$i."'"; 
                                            	if($list['check_minute']==$i){
...
// 					$('#edit_standard_model').html(html);
		...
		$(document).on('click', '#merchant_no', function() {
			$("#setMoreName").hide();
			$('input[name="Set[more_val]"]').attr('placeholder','请输入商品编码');
			$("#setMoreVar").show();
...
//    			$("#chose_step").attr("class","contant shop_edit");
        ...
        <?php if(!empty($list['use_time_type']) && $list['use_time_type'] == DSHOP_TIME_TYPE) { ?>            
                $('#date_num1').attr("disabled", "disabled"); 
                $('#date_num2').removeAttr("disabled");
        <?php } else { ?>
                $('#date_num1').removeAttr("disabled");
