...
<?php if ('index' == Yii::app()->getController()->getId() || 'shopIndex' == Yii::app()->getController()->getId()) { ?>
	...
	<div class="header clearfix">
		<div class="top">
	      ...
	      <div class="logo"><a href="<?php echo Yii::app() -> createUrl('index/home/index')?>"><img src="<?php echo GJ_STATIC_IMAGES?>logo1.png"></img></a></div>
...
<div class="backCellphone">
    ...
    <div class="phone">
    	<img src="<?php echo GJ_STATIC_IMAGES?>qrcode_app.png"/><br/>移动版
    </div>
    <script>
		$(".cellphone").hover(
			function(){
