...
<head>
    ...
    <!--artDialog 弹出框插件 开始-->
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/artDialog/jquery.artDialog.js?skin=simple"></script>
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/artDialog/plugins/iframeTools.js"></script>
    <!--artDialog 弹出框插件 结束-->
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/jquery.zclip.min.js"></script>
    <!--uploadify插件 开始-->
    <script src="<?php echo WQ_STATIC_JS?>lib/uploadify/jquery.uploadify.min.js"></script>
    <!--uploadify插件 结束-->
    <script src="<?php echo WQ_STATIC_JS?>common/upload.js"></script>
    <!--时间插件 开始-->
