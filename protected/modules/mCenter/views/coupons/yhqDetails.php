    ...
    <div class="contant" style="background:#fafafa;min-height:300px">
         <div class="filed">
            ...
            <div class="filed">
              ...
              <div class="filed">
                <span class="label">折扣数:</span>
               <span class="text"> <?php echo $list['discount']; ?></span>
              </div>
              
             <!--   <div class="filed">
                <span class="label">最高折扣金额:</span>
               <span class="text"> <?php //echo $list['max_discount_money']; ?></span>
              </div>-->
              
               <div class="filed">
                <span class="label">最低消费:</span>
               <span class="text"> <?php echo $list['min_pay_money']; ?></span>
              </div>
              ...
              <div class="filed">
               ...
               <span class="text"> <a href="<?php echo Yii::app()->createurl('mCenter/coupons/yhqList'); ?>" style="background:#f63;color:#fff;padding:8px 20px">返回</a>     </span>
              </div>
