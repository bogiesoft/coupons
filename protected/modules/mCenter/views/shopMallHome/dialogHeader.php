...
<div class="popWrap" id="pop" style="width:785px;height:400px; display:">
	<div class="pop_con pIndexEdit">
        <div class="title">
        	...
        	<span class="name" style="display:"><!--这是“首页设置-添加链接”的头部-->
            	<a href="<?php echo Yii::app()->createUrl('mCenter/shopMallHome/dialogHeader',array('shop_type'=>SHOP_TYPE_GROUP,'index'=>$index,'flag'=>$flag,'type' => $type)); ?>" class="<?php if(isset($_GET['shop_type'])){echo $_GET['shop_type']==SHOP_TYPE_GROUP?'blue':'';}elseif (empty($_GET['shop_type'])){echo 'blue';} ?>">商品分组</a> |
                <?php if($_GET['shop_group']=='false'){?><a href="<?php echo Yii::app()->createUrl('mCenter/shopMallHome/dialogHeader',array('shop_type'=>SHOP_TYPE_PRODUCT,'index'=>$index,'flag'=>$flag,'type' => $type)); ?>" class="<?php if(isset($_GET['shop_type'])){echo $_GET['shop_type']==SHOP_TYPE_PRODUCT?'blue':'';} ?>">商品</a> <?php }?>
<!--         	                <a href="#" class="">添加商品</a> -->
            </span>
        ...
        <div class="pop_content">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" border="0">
                <tr class="orderHead">
                    ...
                    <td>
                        <?php echo CHtml::beginForm(Yii::app()->createUrl('mCenter/shopMallHome/dialogHeader'),'get',array('id'=>'searchForm')); ?>
                        <div class="sh-search clearfix">
