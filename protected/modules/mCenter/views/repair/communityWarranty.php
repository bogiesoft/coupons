        ...
        <div class="form-inline">
            ...
            <div class="form-group ml10">
                ...
                <div class="form-group excel-operate fr">
                    <button type="button" onclick="window.location.href = '<?php echo Yii::app()->createUrl('mCenter/repair/GetRepairExcel');?>'">
                        EXCEL导出
                    </button>
                </div>
            </form>
                    ...
                    <div class="m-operate">
                        ...
                        <ul class="m-operate-list">
                            <?php if($v['status'] == REPORT_REPAIR_RECORD_STATUS_WAITING){?>
                                <li>
                                    <a href="<?php echo Yii::app()->createUrl('mCenter/Repair/RepairStatus', array('repair_id' => $v['id'], 'goUrl' => Yii::app()->request->url));?>" onclick="return confirm('确认完成吗？');">确认</a>
                                </li>
                            <?php }?>
