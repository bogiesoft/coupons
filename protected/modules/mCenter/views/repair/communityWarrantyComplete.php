        ...
        <div class="form-inline">
            ...
            <div class="input-group ml10">
                ...
                <div class="form-group excel-operate fr">
                    <button type="button" onclick="window.location.href = '<?php echo Yii::app()->createUrl('mCenter/repair/GetRepairExcel', array('status' => REPORT_REPAIR_RECORD_STATUS_COMPLETE));?>'">
                        EXCEL导出
                    </button>
                </div>
            </form>
                ...
                <td>
                    <div class="m-operate">
                        ...
                        <ul class="m-operate-list">
                            <li><a href="<?php echo Yii::app()->createUrl('mCenter/Repair/ReportRepairRecordDetail',
                                    array('repair_id'=>$v['id']));?>">查看详情</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
