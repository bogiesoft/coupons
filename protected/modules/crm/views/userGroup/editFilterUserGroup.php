                        ...
                        <div class="new_group_item">
                            ...
                            <div class="new_group_item_c">
                                <ul class="filtrate_item">
                                    ...
                                    <li class="js_3"><span>生日范围</span></li>
                                    <li class="js_4"><span>来源</span></li>
                                    <li class="js_5"><span>会员等级</span></li>
                                    <!--<li class="js_6 last"><span>客户价值</span></li>-->
                                </ul>
                            </div>
                        </div>
                        <div class="new_group_item">
                            ...
                            <div class="new_group_item_c">
                                <ul class="filtrate_item">
                                    <li class="js_7"><span>消费金额</span></li>
                                    <li class="js_8"><span>客单价</span></li>
                                    <li class="js_9"><span>最高消费</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="new_group_item">
                            ...
                            <div class="new_group_item_c">
                                <ul class="filtrate_item">
                                    <li class="js_10"><span>消费次数</span></li>
                                    <li class="js_11"><span>消费天数</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="new_group_item">
                            ...
                            <div class="new_group_item_c">
                                <ul class="filtrate_item">
                                    <li class="js_12"><span>最近消费时间</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <!-- 数据输入区域 -->
                    <div class="new_group filtrate_area" style="display: block">
                        <div class="new_group_item js_1 filtrate_condition" n="condition_sex" id="age_param" style="display: none">
                            <h3>性别</h3>
                            <div class="new_group_item_c">
                        ...
                        <div class="pop_content new_pop_content">
                            <div class="setting_content">
                                <div class="setting_item">
                                    ...
                                    <input type="text" name="group_name" value="<?php echo $user_group->name?>" class="text_group" placeholder="请输入分组名称，最多16个汉字" maxlength="16">
                                </div>
                                <div class="setting_item">
                                    <span>分组类型</span>
                                    <ul class="clean_cycle">
                                        <li class="first">
                                            <label>
                                                <input type="radio" name="group_type" value="<?php echo GROUP_TYPE_DYNAMIC?>" id="type_dynamic" <?php if($user_group->type == GROUP_TYPE_DYNAMIC) {?>checked<?php }?>><?php echo $group_types[GROUP_TYPE_DYNAMIC]?></label>
                                            <p>分组内成员和数量会根据条件每天变化</p>
                                        </li>
                                        <li>
                                            <label>
                                                <input type="radio" name="group_type" value="<?php echo GROUP_TYPE_STATIC?>" id="type_static" <?php if($user_group->type == GROUP_TYPE_STATIC) {?>checked<?php }?>><?php echo $group_types[GROUP_TYPE_STATIC]?></label>
...
<script>
    var filter_json = '<?php echo $user_group->filter_condition ?>';
