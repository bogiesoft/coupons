...
<head>
    ...
    <script src="<?php echo WQ_STATIC_JS?>lib/artDialog/jquery.artDialog.js?skin=simple"></script>
    <script src="<?php echo WQ_STATIC_JS?>lib/artDialog/plugins/iframeTools.js"></script>
