...
<h4 class="g-title">流失客户赠券<span class="g-title-desc">有消费过，但最近两个月没有消费</span> </h4>
        ...
        <div class="m-estate-box m-market-box mb10">
            <section class="m-cp-item">
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        流失客户，当前分组人数<?php echo count($user_info);?>人（刷新时间：<?php echo date("Y-m-d H:i:s",$refresh_time);?>）
                    </div>
                </div>
                <div class="form-group m-cp-info">
                    <div class="cp-title mt6">
                    ...
                    <div class="cp-con">
                        ...
                        <span class="choosed-link pl10 choose_coupon_result">
                            <?php echo $edit_flag&&!empty($edit_flag) ? $GLOBALS['COUPON_TYPE'][$marketing_info['coupon_type']] . '>'. $marketing_info['coupon_name'] : '' ?>
                            <!--券类型>券名称--></span>
...
<!--                        </div>-->
        ...
        <div class="form-inline m-form-group mt30">
            ...
            <input type="hidden" name="Marketing[type]" value="<?php echo MARKETING_ACTIVITY_TYPE_BASICS_LSKHMA;?>">
