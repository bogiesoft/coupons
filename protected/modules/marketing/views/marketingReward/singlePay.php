...
<h4 class="g-title">单次消费满赠券<span class="g-title-desc">给单次消费满一定金额的客户赠券</span> </h4>
...
<div class="m-estate-box m-market-box mb10">
    ...
    <div class="form-inline m-form-group mt30" style="margin-bottom: 150px">
        ...
        <input type="hidden" name="Marketing[type]" value="<?php echo MARKETING_ACTIVITY_TYPE_BASICS_DCXFMMA;?>">
