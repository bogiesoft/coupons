...
<h4 class="g-title">首次支付赠券<span class="g-title-desc">给首次支付的客户赠券</span> </h4>
<div class="g-container">
    ...
    <form action="<?php echo $this->createUrl('marketingNewCustomer/marketingNewCustomerAdd') ?>" id="marketing_form" method="post">
        ...
        <div class="form-inline m-form-group mt30">
            ...
            <input type="hidden" name="Marketing[type]" value="<?php echo MARKETING_ACTIVITY_TYPE_BASICS_SCZFMA;?>">
