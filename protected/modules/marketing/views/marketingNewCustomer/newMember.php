...
<h4 class="g-title">新会员赠券<span class="g-title-desc">给加入30天但只消费过一次的会员赠送优惠券</span> </h4>
<div class="g-container">

    <form action="<?php echo Yii::app()->createUrl('marketing/MarketingNewCustomer/MarketingNewCustomerAdd');?>" id="marketing_form" method="post">
        <div class="m-estate-box m-market-box mb10">
            <section class="m-cp-item">
                ...
                <div class="form-group m-cp-info">
                    ...
                    <div class="cp-con">
                        新会员，当前分组人数<?php echo count($user_info);?>人（刷新时间：<?php echo date("Y-m-d H:i:s",$refresh_time);?>）
                    </div>
                </div>
                <div class="form-group m-cp-info">
                    <div class="cp-title mt6">
...
<!--                </div>-->
        ...
        <div class="m-estate-box m-market-box mb10">
            ...
            <div class="form-inline m-form-group mt30">
                ...
                <input type="hidden" name="Marketing[type]" value="<?php echo MARKETING_ACTIVITY_TYPE_BASICS_XHYMA;?>">
