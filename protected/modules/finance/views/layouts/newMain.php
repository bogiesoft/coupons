...
<head>
    ...
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>main.js"></script>
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/jquery.validate.js"></script>
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/messages_zh.min.js"></script>
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/echarts.min.js"></script>
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/select2.min.js"></script>
    <!--时间插件 开始-->
    ...
    <!--时间插件 结束-->
    <!--时间插件2 开始-->
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/bootstrap-datepicker/bootstrap-datepicker.js"></script>
    <script type="text/javascript" src="<?php echo WQ_STATIC_JS?>lib/bootstrap-datepicker/bootstrap-datepicker.zh-CN.min.js"></script>
    <!--时间插件2 结束-->
    <!--layer 开始-->
    <script type="text/javascript" src="<?php echo WQ_STATIC_MEDIA?>js/layer/layer.js"></script>
    <!--layer 结束-->
    <!--[if lt IE 9]>
