...
<head>
    ...
    <link rel="stylesheet" href="<?php echo GJ_STATIC_JS?>uploadify/uploadify.css">
    <link type="text/css" rel="stylesheet" href="<?php echo GJ_STATIC_JS ?>js_gj/plus/daterangepicker/daterangepicker.css"/>
    <link rel="stylesheet" href="<?php echo GJ_STATIC_JS?>js_gj/plus/bootstrap-datepicker/datepicker.css">
<!--    <script src="--><?php ///*echo WQ_STATIC_JS*/?><!--lib/jquery.min.js"></script>-->
    ...
    <script type="text/javascript" src="<?php echo GJ_STATIC_JS?>uploadify/jquery.uploadify.min.js"></script>
    ...
    <script type="text/javascript" src="<?php echo GJ_STATIC_JS ?>js_gj/plus/daterangepicker/moment.min.js"></script>
    <script type="text/javascript" src="<?php echo GJ_STATIC_JS ?>js_gj/plus/daterangepicker/daterangepicker.js"></script>
    <script src="<?php echo GJ_STATIC_JS?>js_gj/plus/bootstrap-datepicker/bootstrap-datepicker.js"></script>
    <script src="<?php echo GJ_STATIC_JS?>js_gj/plus/bootstrap-datepicker/bootstrap-datepicker.zh-CN.min.js"></script>
    <!--[if lt IE 9]>
