...
<script type="text/javascript">
     $('#management_first').change(function(){
         ...
         if(arr[1] == 'm'){
             var id = arr[0];
	    	 $.ajax({
	  	        url: '<?php echo($this->createUrl('GetSubManagementAndStore'));?>',
	  	        data: {id: id},
	  	        type: 'post',
	  	        dataType: 'json',
     ...
     function selectM(){
         ...
         if(arr[1] == 'm'){
             var id = arr[0];
	    	 $.ajax({
	  	        url: '<?php echo($this->createUrl('GetStoreByManagement'));?>',
	  	        data: {id: id},
	  	        type: 'post',
	  	        dataType: 'json',
	  	        success: function (data) { 
    ...
    function tradetrend(){
        ...
        $.ajax({
  	        url: '<?php echo($this->createUrl('GetTradeTrend'));?>',
    ...
    function tradeachievement(){
        ...
        $.ajax({
  	        url: '<?php echo($this->createUrl('GetStoreTrade'));?>',
  	        data: {time:time},
  	        type: 'post',
  	        dataType: 'json',
  	        success: function (data) {
