<?php
define('WEB_DOMAIN','kgj.com');//网站域
define('WWW_DOMAIN','http://www.'.WEB_DOMAIN);//主站域
define('MGR_DOMAIN','http://branch.home.mgr.'.WEB_DOMAIN);//后台域
define('FX_DOMAIN','http://fx.'.WEB_DOMAIN);//管家域
...
define('USER_DOMAIN', 'http://wap.'.WEB_DOMAIN.'/uCenter/user');//用户域
define('USER_DOMAIN_COUPONS', 'http://wap.'.WEB_DOMAIN.'/uCenter/Coupon');//用户优惠券域
define('COMMODITY_DOMAIN', 'http://wap.'.WEB_DOMAIN.'/mall/Commodity');//在线商城
define('COMMODITY_DOMAIN_DQH', 'http://wap.'.WEB_DOMAIN.'/Dmall/Commodity');//东钱湖在线商城
define('COMMODITY_DOMAIN_DQH_MARKETING', 'http://wap.'.WEB_DOMAIN.'/Dmall/Activity');//东钱湖营销活动
define('PROMOTIONS_DOMAIN', 'http://wap.'.WEB_DOMAIN.'/uCenter/promotions');//应用域
define('WEB_APP_DOMAIN', 'http://wap.'.WEB_DOMAIN.'/mobile');//应用市场域

define('UPLOAD_TO_PATH','http://upload.'.WEB_DOMAIN.'/upload.php');//上传附件路径
define('UPLOAD_FILE_TO_PATH','http://upload.'.WEB_DOMAIN.'/uploadfile.php');//上传PEM附件路径
define('IMG_BASE_PATH','http://upload.'.WEB_DOMAIN.'/images/');//图片存放基本路径径
define('CERT_BASE_PATH','http://upload.'.WEB_DOMAIN.'/cert/');//PEM存放基本路径径
define('QRCODE_IMG_URL','http://upload.'.WEB_DOMAIN.'/qrcode/');//二维码图片地址
...
define('IMG_MGR_FOLDER','mgr');  //老OA
define('WY_EXCEL_FOLDER','wy_excel');  //物业excel
define('IMG_MGR_LIST',IMG_BASE_PATH.IMG_MGR_FOLDER.'/source/');


define('IMG_GJ_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/source/');    //原图路径
define('IMG_GJ_600_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/600/');   //商城图片重画后路径
define('IMG_GJ_300_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/300/');   //商城图片重画后路径
define('IMG_GJ_250_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/250/');   //商城图片重画后路径
define('IMG_GJ_150_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/150/');   //商城图片重画后路径
define('IMG_GJ_125_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/125/');   //商城图片重画后路径
define('IMG_GJ_80_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/80/');   //商城图片重画后路径
...
#define('IMG_GJ_LIST',IMG_BASE_PATH.IMG_GJ_FOLDER.'/source/');
...
/*****************支付宝*****************/
//玩券管家
define('ALIPAY_WQ_SYNNOTIFY',FX_DOMAIN.'/aCenter/Notify/SynNotify');//同步
...
//微信公众号
define('INTERFACE_URL', GJ_DOMAIN.'/WechatGateway?account=');//接口URL

//支付宝服务窗
//开发者网关
define('DEVELOPER_GATEWAY', GJ_DOMAIN.'/mCenter/gateway?account=');
//开发者公钥
...
//Wap支付
define('WAPPAY_WQ_SYNNOTIFY',WAP_DOMAIN.'/uCenter/Notify/SynNotify');//同步
define('WAPPAY_WQ_ASYNOTIFY',WAP_DOMAIN.'/uCenter/Notify/AsyNotify');//异步
//wap退款
...
//第三方接口微信异步
define('DWAPPAY_WQ_WECHAT_ASYNOTIFY',WAP_DOMAIN.'/Dmall/Notify/WxPayNotify');//东钱湖商城微信支付异步通知url
define('WAPPAY_WQ_WECHAT_ASYNOTIFY_STORED',WAP_DOMAIN.'/uCenter/Notify/WxPayNotify');//储值微信异步通知地址
...
define('WX_GETCOUPON_URL', GJ_DOMAIN.'uCenter/coupon/newGetCouponOne?coupon_id=');
//省市区xml
