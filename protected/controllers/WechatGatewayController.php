...
//                    ****************************
                        if($result->userExist == true){
                            ...
                            $res = $marketingC->sendWechatCoupons($merchant_id,$type,$fromUsername);
                            $contentStr = $res;
...
//             	}
                ...
                if ($postObj->Event == "user_get_card") {
                    ...
                    $result = json_decode($userUC->changeCode($cardId, $code, $friendUserName, $IsGiveByFriend, $OldUserCardCodee, $OuterId, $fromUsername));
                    Yii::log('outerId:' . $result -> status, 'error');
                }
