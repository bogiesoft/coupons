...
//营销版收费类型
define('MERCHANT_CHARGE_TYPE_SELF_YES', '1');//是
define('MERCHANT_CHARGE_TYPE_SELF_NO', '2');//否
$GLOBALS['__MERCHANT_CHARGE_TYPE'] = array(
		MERCHANT_CHARGE_TYPE_SELF_YES => '是',
		MERCHANT_CHARGE_TYPE_SELF_NO => '否',
);
