...
define('ORDER_PAY_CHANNEL_GROUP', '12'); //集中收银
...
define('MATERIAL_CONTENT_CUSTOMIZE_URL', 3); //跳转自定义链接
$GLOBALS['MATERIAL_JUMP_TYPE']=array(
		MATERIAL_CONTENT_TEXT => '跳转到正文',
		MATERIAL_CONTENT_URL => '跳转到链接',
		MATERIAL_CONTENT_CUSTOMIZE_URL => '跳转到自定义链接'
);
