...
class AlipayApi extends mainClass{
	 ...
	 * @return Ambigous <支付宝处理结果, mixed>
	 */
	public function qrCodeApiV2($order_no, $money, $undiscountable, $appid=NULL, $seller_id=NULL, $store_id=NULL, $auth_token=NULL, $isv='2088701036418655', $subject=NULL, $notify_url=NULL) {
		Yii::import('application.extensions.alifuwu.*');
		require_once("function.inc.php");
		...
		$parameter = array(
				...
				'discountable_amount' => '', //可打折金额
				'undiscountable_amount' => $undiscountable, //不可打折金额
				'subject' => $subject ? $subject : '扫码支付', //订单标题
				'body' => '', //订单描述
				'goods_detail' => array(), //商品明细列表
				'operator_id' => '', //商户操作员编号
				'store_id' => $store_id, //商户门店编号
