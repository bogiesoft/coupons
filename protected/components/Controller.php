...
include_once(realpath(dirname(__FILE__).'/../../protected/config').'/bizSorts.php');
...
include_once(realpath(dirname(__FILE__).'/../../protected/class/config').'/constant/sytConstant.php');
include_once(realpath(dirname(__FILE__).'/../../protected/class/config').'/constant/generalConstant.php');
include_once(realpath(dirname(__FILE__).'/../../protected/class/config').'/constant/fxConstant.php');
include_once(realpath(dirname(__FILE__).'/../../protected/class/config').'/constant/mallConstant.php');
include_once(realpath(dirname(__FILE__).'/../../protected/class/config').'/constant/oaConstant.php');
